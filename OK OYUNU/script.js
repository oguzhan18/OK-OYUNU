...
alert("ÇART APP TERCİH ETTİĞİNİZ İÇİN TEŞEKÜRLER..👍👍👍")

alert("Lütfen cihazınızın sessiz modda olmadığından emin olun...");
    ...
    Arrow.prototype.drawArrow = function() {
        if(this.vis) {
            ...
            try{
                                ...
                                document.getElementById("title").innerHTML = "Score<br>"+totalScore;
